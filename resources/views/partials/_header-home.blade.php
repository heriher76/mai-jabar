                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse main-menu-item justify-content-end"
                        ...
                        <span class="d-none d-sm-flex d-md-flex d-lg-flex">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('news') }}" style="font-weight: 1000; color: white;">Berita</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('work-program') }}" style="font-weight: 1000; color: white;">Program Kerja</a>
                            </li>
                            <li class="nav-item">
